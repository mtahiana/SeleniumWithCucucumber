...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Selenium 4
        System.setProperty("webdriver.chrome.driver", "/Users/Tahiana/ChromeDriver/chromedriver");
    ...
    private static void inspectDetached(DevTools devTools) {
        ...
        targetInfos.forEach(
                targetInfo -> {
                    ...
                    Set<TargetInfo> sessionId = devTools.send(attachToTarget(targetInfo.getTargetId(), Optional.of(false)));
                    devTools.send(
